...
public class RequiredMedian {

    SingelyLinkedList[] arr; // For storing user inputs.

    RequiredMedian(SingelyLinkedList[] arr) {
        this.arr = arr;
    }

    SingelyLinkedList MergeAll() { // To merge all the linked list in sorted order.
    ...
    void Median() {
        ...
        System.out.println("Median: " + MergeAll().getatAnyPoint(median)); // Print the median.
    }
    ...
    public static void main(String[] args) {
        ...
        arr[1] = L2;
        arr[2] = L3;
        RequiredMedian answer = new RequiredMedian(arr);
        answer.Median();
